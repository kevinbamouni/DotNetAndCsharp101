...
namespace XUnitReservingPAndCTest
{
    public class UnitTest1
    {
        ...
        public void ChainLadderGetRowNTest1()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetRowN(this.arr2d, 3));
        }
        ...
        public void ChainLadderGetRowNTest2()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetRowN(this.arr2d, 0));
        }
        ...
        public void ChainLadderGetRowNTest3()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetRowN(this.arr2d, 4));
        }

        [Fact]
        public void ChainLadderGetRowNTest4()
        {
            Assert.Throws<IndexOutOfRangeException>(()=> ChainLadder.GetRowN(this.arr2d, 10));
        }
        ...
        public void ChainLadderGetColumnNTest1()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetColumnN(this.arr2d, 3));
        }
        ...
        public void ChainLadderGetColumnNTest2()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetColumnN(this.arr2d, 0));
        }
        ...
        public void ChainLadderGetColumnNTest3()
        {
            ...
            Assert.Equal<decimal[]>(a, ChainLadder.GetColumnN(this.arr2d, 4));
        }
    }
}